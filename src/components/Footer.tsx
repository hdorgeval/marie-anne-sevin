      ...
      <div className="d-flex flex-column align-items-center">
        <div className="d-flex p-4 flex-row align-items-center">
          ...
          <span className="fs-1 ms-3">
            <a className="nav-link" href="https://wa.me/33683479774" rel="nofollow" target="_blank">
          ...
          <span className="fs-1 ms-3">
            <a className="nav-link" href="https://amzn.eu/d/dd3iN4K" rel="nofollow" target="_blank">

        ...
        <div className="d-flex px-0 pt-4 flex-column justify-content-between">
          <SemiTransparentTile className="card text-start text-light font-monserrat">
            ...
            <div className="card-body pt-2">
              <Description>
                Ce module tantra femme est une invitation à vous relier au côté animal et archaïque
                de la femme. Rituels en pleine nature, méditations, chants et danses vous amèneront
                petit à petit à laisser cette part sauvage s'exprimer et ainsi libérer désir,
                créativité et sexualité. En accueillant l'expression de votre ventre, vous pourrez
                la relier au cœur ainsi qu'à la conscience et rayonner à partir de cet axe puissant,
                en confiance. La synergie créée par la rencontre de ces femmes uniques permet de se
                soutenir mutuellement dans cette initiation, cette rencontre avec la nature, avec
                votre nature.
              </Description>
            </div>
          </SemiTransparentTile>
          ...
          <SemiTransparentTile className="card text-start text-light font-monserrat mt-4">
            <div className="card-body">
              <OpenExternalLinkButton
                ...
                link="https://forms.gle/hMsZySnjJAsWJq54A"
              ...
              <TransparentListGroupItem className="">
                <AnimatedBy>
                  ...
                  <AnimatedBy.Description>
                    ...
                    ma vie. Sur le chemin du tantra depuis 15 ans, je propose stages, retraites et
                    soirées tantra ainsi que des soins individuels ou couple. J'accompagne les
                    femmes depuis plus de 25 ans par le chant, le travail corporel et l'écoute.
                  </AnimatedBy.Description>
                </AnimatedBy>
              </TransparentListGroupItem>
            </ul>

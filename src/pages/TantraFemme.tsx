        ...
        <div className="d-flex px-0 pt-4 flex-column justify-content-between">
          <SemiTransparentTile className="card text-start text-light font-monserrat">
            ...
            <div className="card-body pt-2">
              <Description>
                Ce module avancé* tantra femme est une invitation à vous relier à l'espace sacré en
                vous. Rituels, méditations, chants et danses vous amèneront petit à petit à laisser
                la divine s'exprimer et ainsi libérer votre potentiel. En accueillant l'expression
                de votre sexe, vous pourrez la relier au cœur ainsi qu'à la conscience et rayonner à
                partir de cet axe puissant, en confiance. La synergie créée par la rencontre de ces
                femmes uniques permet de se soutenir mutuellement dans cette initiation, pour oser
                l'intimité et l'authenticité. *entretien téléphonique préalable
              </Description>
            </div>
          </SemiTransparentTile>
            ...
            <ul className="list-group list-group-flush">
              ...
              <TransparentListGroupItem className="">
                <AnimatedBy>
                  ...
                  <AnimatedBy.FigCaption>
                    Charlotte, ostéopathe et animatrice de cercles de femmes et de stages de tantra.
                  </AnimatedBy.FigCaption>
                </AnimatedBy>
              </TransparentListGroupItem>
            </ul>

				...
				>
					<div className="container h-100 d-flex flex-column justify-content-between align-items-center overflow-y-scroll">
						...
						<div>
							...
							<PageSubTitle className="fs-7">
								Au service des entreprises et des institutions (écoles, crèches,
								ephad ...)
							</PageSubTitle>
							...
							<PageSubTitle className="fs-7">
								Bien-être du dirigeant (un accompagnement global corps et
								conscience)
							</PageSubTitle>
							<PageSubTitle className="fs-7">
							...
							<PageSubTitle className="fs-7">
								Constellations Systémiques en entreprise
							</PageSubTitle>
							<PageSubTitle className="fs-7">
								Cohésion d’équipe (mandala vocal, sensibilisation au handicap,
								théâtre…)
							</PageSubTitle>
							<PageSubTitle className="fs-7">
								Manager musicien Evénementiel (de la chanson française à la
								soul)
							</PageSubTitle>
							<PageSubTitle className="fs-7">
								Spectacles (crèches et écoles)
							</PageSubTitle>
						</div>

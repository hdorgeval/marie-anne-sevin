          ...
          <div className="d-flex px-0 pt-4 flex-column justify-content-between">
            <SemiTransparentTile className="card text-start text-light font-monserrat">
              ...
              <div className="card-body pt-2">
                <Description>
                  Vous souhaitez apprendre et partager le toucher méditatif avec un ou une
                  partenaire ? Je propose un cursus de 3 x 3h pour 2 personnes. Lors de ces 3
                  sessions, je vous transmets des clefs pour apprivoiser ce toucher spécifique à
                  travers la méditation et des exercices pratiques. Chacun d'entre vous est invité à
                  donner et recevoir afin d'affiner ses perceptions et de trouver le juste contact.
                </Description>
              </div>
            </SemiTransparentTile>

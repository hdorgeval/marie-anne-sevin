				...
				>
					<div className="container h-100 d-flex flex-column justify-content-between align-items-center overflow-y-scroll">
						...
						<div className="fs-6 fw-bolder font-monserrat mt-4 mx-4 text-start text-light">
							<p className="">
								Musicienne, masseuse, thérapeute, formatrice et auteure, je
								conçois et j'anime des ateliers pédagogiques et thérapeutiques.
							</p>
							<p>
								Riche de plusieurs approches artistiques, j'accompagne aussi
								bien des clients institutionnels que des particuliers, de la
								périnatalité jusqu'à la fin de vie.
							</p>
							<p className="mb-0 pb-0">
								Très impliquée dans le bien-être par la voix et la musique, le
								massage tantrique, la méditation, la sonothératpie et les
								constellations familiales et systémiques, je crée en 2021
								A.R.T.S - Accompagnement Relationnel Thérapeutique et
								Systémique.
							</p>

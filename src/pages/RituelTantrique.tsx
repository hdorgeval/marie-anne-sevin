                ...
                <TransparentListGroupItem className="mt-0 pt-3">
                  <div className="d-flex flex-row align-items-center card-subtitle">
                    ...
                    <div className="d-flex flex-column card-subtitle">
                      <span className="text-nowrap fs-7">17 rue Philippe de Dangeau</span>
                      <span className="text-nowrap fs-7"> Versailles (78)</span>
                    </div>
                  </div>
                </TransparentListGroupItem>
              ...
              <ul className="list-group list-group-flush">
                  ...
                  <div className="card bg-color-dark-semi-transparent">
                    ...
                    <div className="card-body">
                      <Description>
                        ...
                        sous-vêtement qui ne craint pas l'huile. Vous pouvez à tout moment décider
                        de vous couvrir ou au contraire d'ôter vos sous-vêtements en cours de
                        massage. Ce qui est important, c'est de vous sentir en sécurité afin de
                        profiter pleinement du massage. Me concernant, en tant que masseuse, je
                        porte un boxer et une brassière. Pour les personnes préférant moins de
                        contact peau à peau, je peux mettre un t-shirt et un legging. à contrario,
                        pour les personnes à l'aise avec le contact et la nudité, je porte à minima
                        le boxer. Je ne masse pas nue.
                      </Description>
                    </div>
                  </div>
                </TransparentListGroupItem>
                ...
                <TransparentListGroupItem className="pb-2">
                  <div className="card bg-color-dark-semi-transparent">
                    ...
                    <div className="card-body">
                      <Description>
                        Tout le corps peut être massé dans la limite du cadre que nous avons
                  ...
                  <div className="card bg-color-dark-semi-transparent">
                    ...
                    <div className="card-body">
                      <Description>
                        ...
                        l'entretien téléphonique ou lors du brief de façon à ce que votre mental
                        soit totalement libre lors du massage. J'y répondrai autant que possible.
                      </Description>
                    </div>
                  </div>
                </TransparentListGroupItem>
                ...
                <TransparentListGroupItem className="pb-2">
                  <div className="card bg-color-dark-semi-transparent">
                    ...
                    <div className="card-body">
                      <Description>
                        Chaque condition médicale étant particulière, je vous invite à demander
                        l'avis de votre médecin avant de prendre rendez-vous. Certains traitements
                        passent la barrière cutanée et pourraient avoir un impact pour moi. Merci de
                        me prévenir afin que je mette des gants pour protéger ma santé. Si vous avez
                        une infections transmissible, merci également de me prévenir afin que je
                  ...
                  <div className="card bg-color-dark-semi-transparent">
                    ...
                    <div className="card-body">
                      <Description>
                        ...
                        j'accompagne ce qui se présente dans un cadre et un protocole défini. Il n'y
                        a pas d'intention de ma part, si ce n'est de célébrer votre être dans toutes
                        ses dimensions (physique, émotionnelles et spirituelles). Ainsi, ce massage
                        peut avoir des vertus relaxante et énergétiques. L'accueil de la sensualité
                        et l'accompagnement de l'énergie sexuelle peuvent vous procurer une
                        dimension érotique ou thérapeutique. La dévotion pour la vie et pour qui
                        vous êtes peut ouvrir à une dimension spirituelle. En revanche, si vous
                        cherchez un massage pour votre mal de dos, pour rééquilibrer votre taux
                        hormonal ou pour une prestation sexuelle, je vous invite à prendre
                        rendez-vous avec un professionnel de ces questions.
                      </Description>
                    </div>
                  </div>
                </TransparentListGroupItem>

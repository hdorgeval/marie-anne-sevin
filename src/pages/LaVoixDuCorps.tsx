          ...
          <div className="d-flex px-0 pt-4 flex-column justify-content-between">
            ...
            >
              ...
              <div className="card-body pt-2">
                <Description>
                  Temps d'exploration corporelle, vocale et créative tout en liberté, vous serez
                  amené à accorder et harmoniser votre corps et votre voix. La musique se vivra par
                  le mouvement, la vibration, l'improvisation et l'exploration… Chanter apporte un
                  réel mieux être physique et psychique. Le travail ostéopathique sur les différents
                  “diaphragmes” amènera souplesse et connaissance de votre lutherie corporelle.
                  Enveloppement sonore, mantras et méditations vous permettra de créer l'harmonie
                  pour vous même, pour le groupe et au delà. Vous pouvez venir avec vos instruments
                ...
                <TransparentListGroupItem className="pb-0">
                  <div className="d-flex flex-row align-items-center card-subtitle">
                    ...
                    <div className="d-flex flex-column card-subtitle">
                      ...
                      <span className="py-2">
                        Vous avez la possibilité d'arriver la veille et de repartir le lendemain
                        sans surcoût.
                      </span>
                    </div>
                  </div>
                ...
                <TransparentListGroupItem className="">
                  <AnimatedBy>
                    ...
                    <AnimatedBy.Description>
                      ...
                      dans ma vie. qui m'ont amenée à créer l'accompagnement Relationnel
                      Thérapeutique et Systémique. Actrice du bien-être par la voix depuis près de
                      25 ans de la périnatalité à la fin de vie.
                    </AnimatedBy.Description>
                  </AnimatedBy>
                </TransparentListGroupItem>
                <TransparentListGroupItem className="">
                  <AnimatedBy>
                    ...
                    <AnimatedBy.Description>
                      ...
                      méditative. Mon objectif est d'ouvrir à la conscience de votre anatomie et à
                      la richesse de vos tissus pour une harmonisation vibratoire.
                    </AnimatedBy.Description>
                  </AnimatedBy>
                </TransparentListGroupItem>
              </ul>

				...
				<div className="container h-100 d-flex flex-column justify-content-between align-items-center overflow-y-scroll">
					...
					<div className="fs-6 fw-bolder mt-4 mx-4 text-start text-body-secondary">
						<p>
							...
							https://marie-anne-sevin.com , ci-après le "Site", les présentes
							mentions légales.
						</p>
						<p>
						...
						<p className="mt-3">
							L'édition du Site est assurée par A.R.T.S SARL unipersonnelle au
							capital de 3000 euros, immatriculée au Registre du Commerce et des
							Sociétés de Trappes sous le numéro 899171433 dont le siège social
							est situé au 31 RUE RIEUSSEC 78220 VIROFLAY.
						</p>
						<p>Numéro de téléphone : 0683479774</p>
						<p>Adresse e-mail : arts78.mas@gmail.com.</p>
						<p>N° de TVA intracommunautaire : FR86899171433 </p>
						<p>
							Le Directeur de la publication est Marie-Anne Sévin ci-après
							l'"Editeur".
						</p>
						<h3 className="fs-5 text-emphasize pt-2 fw-bolder border-bottom border-bottom-1 pb-1 text-uppercase">
						...
						<p className="mt-3">
							L'hébergeur du Site est la société Netlify Inc, dont le siège
							social est situé au 44 Montgomery Street, Suite 300, San

...
const inscriptionLink =
	"https://www.billetweb.fr/soiree-tantra3&multi=42233&color=635BFF&parent=mas&color=635BFF";
...
function getEventLastDetailLocationByDate(
	...
	const locationDetails =
		events.findLast((e) => e.date === expectedDate)?.location ?? [];
	...
	return (
		...
		>
			<div>
				...
				<div>
					<PageSubTitle>
						{allDatesArePassed ? "Dates à venir" : dueDate}
					</PageSubTitle>
				</div>
				<div>
					<PageSubTitle>
				...
				<div className="d-flex px-0 pt-4 flex-column justify-content-between">
								...
								<div className="d-flex flex-row align-items-center card-subtitle">
									...
									<div className="d-flex flex-column card-subtitle pt-1">
										<span className="text-nowrap fs-7">
											3 heures, de 19h30 à 22h30
										</span>
										<span className="text-nowrap fs-7">
											Merci d'arriver à 19h15
										</span>
									</div>
								</div>
                    ...
                    <span className="text-nowrap fs-7"> Jouars Ponchartrain (78)</span> */}
										...
										<div className="d-flex flex-column justify-content-between ">
											...
											{theme ? (
												...
												<span className="text-light">
													Le thème sera communiqué ultérieurement
												</span>
											)}
							...
							<TransparentListGroupItem className="py-3">
								<div className="d-flex flex-row card-subtitle align-items-center">
									...
									<div className="d-flex flex-column justify-content-between ">
										...
										<span className="">
											Marie-Anne Sévin{" "}
											<CallablePhoneNumber phoneNumber="06 83 47 97 74" />
										</span>
									</div>
								</div>
							</TransparentListGroupItem>
										...
										<div className="d-flex flex-column card-subtitle">
											...
											{nextDates.map((d) => (
												<div key={d.date} className="ps-1 text-light">
													...
													{getEventLastDetailLocationByDate(
														events,
														d.dateInIsoFormat,
													) && (
														<>
						...
						<div className="card-body pt-2 pb-1">
							<Description>
								Atelier ouvert à toute personne souhaitant découvrir et partager
								l'univers du tantra.
							</Description>
						</div>
					</SemiTransparentTile>

      ...
      <div>
        ...
        <div className="d-flex px-0 pt-4 flex-column justify-content-between">
            ...
            <div className="card-body pt-2">
              <ReadMoreReadLess height="100px" readMoreText="Lire plus" readLessText="Lire moins">
                <Description>
                  ...
                  papiers) et nous ressentons les tensions ou les facilités, ce qui ce joue dans le
                  système. Nous observons le système évoluer pas à pas, en orientant vers un
              ...
              <TransparentListGroupItem className="mt-0 pt-3">
                <div className="d-flex flex-row align-items-center card-subtitle">
                  ...
                  <div className="d-flex flex-column card-subtitle">
                    <span className="text-nowrap fs-7">Saint Quentin en Yvelines (78)</span>
                  </div>
                </div>
              </TransparentListGroupItem>
              ...
              <TransparentListGroupItem className="mt-0 pt-3">
                <div className="d-flex flex-row align-items-center card-subtitle">
                  ...
                  <div className="d-flex flex-column card-subtitle">
                    ...
                    <span className="text-nowrap fs-7">Le lien sera fourni après inscription</span>
                  </div>
                </div>
              </TransparentListGroupItem>
              <TransparentListGroupItem className="pt-1 pb-0">
          ...
          <SemiTransparentTile className="card text-start text-light font-monserrat mt-4">
            ...
            <div className="card-body pt-2 pb-0">
              <Description>
                Nous prenons une date pour le mois d'après et je cherche un local dans lequel pourra
                avoir lieu la constellation. Nous communiquons sur les réseaux notre recherche de
                représentants qui s'engagent à vous accompagner le jour J pour 2h. Ils profitent
                également des prises de conscience et ce travail agit sur l'ensemble des
                participants de part les effets miroirs.
              </Description>
            </div>
          </SemiTransparentTile>
        </div>
